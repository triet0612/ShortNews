<script>
    import { NewsSource, createSource } from "$lib/rss";
    /**
     * @type {NewsSource}
     */
    let rss = new NewsSource("", "", "");
</script>
<form>
    <h1 class="p-5 text-center text-3xl font-extrabold">Create a new RSS:</h1>
    <div class="flex flex-col gap-10 text-center py-5 px-10">
